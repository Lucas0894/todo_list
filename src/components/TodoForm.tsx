      ...
      <div>
        <form className="flex flex-col gap-3 justify-center p-6 lg:flex-row" onSubmit={handleSubmit}>
          ...
          <div className="w-full flex justify-center items-center lg:w-25">
            <button type="submit" className="w-full lg:w-25 rounded bg-blue-700 cursor-pointer p-1 lg:ml-2 text-center text-white shadow-sm hover:shadow-md hover:bg-blue-800 active:scale-95 transition-all duration-200">Agregar Tarea</button>
          </div>
        </form>
      </div>
    </>
